...
| 16 | 15 | 15 | Stage 15: MCP Write Final Investment Records | Copy and write the Stage 14 structured investment records through the dedicated MCP writer. |
...
| 18 | 17 | 17 | Stage 17: MCP Write Sector Memory Rows | Copy and write the Stage 16 sector memory rows through the dedicated MCP writer. |
